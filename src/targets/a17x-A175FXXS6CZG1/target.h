...
#define BUILD_VARIANT_LABEL "a17x-A175FXXS6CZG1-porting-app-safe-p16-c4x3"
...
#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define DEFAULT_EXPLOIT_ATTEMPTS 6
#define APP_EXPLOIT_ATTEMPTS_CAP 3
#define SLIDE_KERNEL_PAGE_SETUP_ATTEMPTS 3
